...
export async function changeGuardPassword(
...
export async function updateGuardLanguagePreference(
  language: string,
): Promise<ChangePasswordResult> {
  ...
  try {
    ...
    return {
      error: "Unable to update language right now. Please try again.",
    };
  }
