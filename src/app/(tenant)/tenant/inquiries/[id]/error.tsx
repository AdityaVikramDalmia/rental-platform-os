...
export default function TenantInquiryDetailError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[Tenant Inquiry Detail Error]", error);
  }, [error]);
  ...
  return (
    <Card className="border-amber-200 bg-amber-50/70 shadow-sm">
      ...
      <CardContent className="space-y-3 text-sm text-amber-800">
        <p>The inquiry may have been removed. Check your connection and try again.</p>
